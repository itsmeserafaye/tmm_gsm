        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (operatorRegisterForm) {
                ...
                operatorRegisterForm.addEventListener('submit', async (e) => {
                    ...
                    fd.set('operator_type', (f.operator_type ? String(f.operator_type.value || '') : '').trim() || 'Individual');
                    ...
                    fileInputs.forEach((inp) => {
                        if (inp.files && inp.files[0] && inp.name) fd.append(inp.name, inp.files[0]);
                    });
