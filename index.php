...
<body class="bg-custom-bg min-h-screen flex flex-col">
                    ...
                    <div class="leading-tight">
                        <h1 class="text-xl lg:text-2xl font-bold" style="font-weight: 700;">
                            <span class="text-slate-800">Transport & Mobility</span> <span
                                class="text-custom-secondary">Management</span>
                        </h1>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 hover:shadow-2xl transition-all">
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <a href="<?php echo htmlspecialchars($baseUrl); ?>/gsm_login/index.php?mode=staff"
                            class="mt-5 inline-flex items-center justify-center gap-2 text-custom-secondary font-semibold hover:underline">
            ...
            <div class="relative overflow-hidden rounded-2xl shadow-xl">
                ...
                <div class="relative px-6 py-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="text-center">
                            <div
                                class="mx-auto w-12 h-12 rounded-full bg-custom-primary text-white flex items-center justify-center font-bold">
                                1</div>
                        ...
                        <div class="text-center">
                            <div
                                class="mx-auto w-12 h-12 rounded-full bg-custom-secondary text-white flex items-center justify-center font-bold">
                                2</div>
                        ...
                        <div class="text-center">
                            <div
                                class="mx-auto w-12 h-12 rounded-full bg-custom-accent text-white flex items-center justify-center font-bold">
                                3</div>
    ...
    <div class="fixed bottom-6 right-6 z-50">
        <div class="bg-white border border-slate-200 shadow-lg rounded-lg p-1 flex items-center gap-1">
            <button type="button" id="langEN"
                class="px-3 py-1.5 rounded-md text-xs font-bold bg-custom-primary text-white">EN</button>
            <button type="button" id="langFIL"
                class="px-3 py-1.5 rounded-md text-xs font-bold text-slate-700 hover:bg-slate-100">FIL</button>
        </div>
    </div>

    <div id="registerFormContainer"
        class="fixed inset-0 bg-black/40 flex items-start justify-center pt-20 px-4 hidden overflow-y-auto z-50">
        <div
            ...
            <div
                ...
                <div class="mt-1 text-xs text-gray-500">
                    ...
                    <button type="button" id="openOperatorRegisterFromCitizen"
                        class="text-custom-secondary font-semibold hover:underline">Register here</button>
                </div>
            </div>
            <form id="registerForm" class="space-y-5 pt-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm mb-1">Middle Name<span id="middleAsterisk"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="regPassword" name="regPassword" minlength="10" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg pr-10"
                                aria-describedby="pwdChecklist">
                            <button type="button"
                                class="absolute inset-y-0 right-0 px-3 text-gray-500 hover:text-gray-700 toggle-password"
                                aria-label="Toggle password visibility" data-target="regPassword">
                                <i class="far fa-eye"></i>
                            </button>
                        </div>
                        <ul id="pwdChecklist" class="text-xs text-gray-600 mt-2 space-y-1">
                            <li class="req-item" data-check="length"><span class="req-dot"></span> At least 10
                                characters</li>
                            <li class="req-item" data-check="upper"><span class="req-dot"></span> Has uppercase letter
                            </li>
                            <li class="req-item" data-check="lower"><span class="req-dot"></span> Has lowercase letter
                            </li>
                            <li class="req-item" data-check="number"><span class="req-dot"></span> Has a number</li>
                            <li class="req-item" data-check="special"><span class="req-dot"></span> Has a special
                                character</li>
                        </ul>
                    </div>
                    <div>
                        <label class="block text-sm mb-1">Confirm Password<span
                                class="required-asterisk">*</span></label>
                        <div class="relative">
                            <input type="password" id="confirmPassword" name="confirmPassword" minlength="10" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg pr-10">
                            <button type="button"
                                class="absolute inset-y-0 right-0 px-3 text-gray-500 hover:text-gray-700 toggle-password"
                                aria-label="Toggle confirm password visibility" data-target="confirmPassword">
                                <i class="far fa-eye"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="space-y-2">
                    <div class="flex items-center text-sm">
                        ...
                        <button type="button" id="openTerms" class="ml-2 text-custom-secondary hover:underline">Terms of
                            Use</button>
                    </div>
                    <div class="flex items-center text-sm">
                        <label class="inline-flex items-center">
                        ...
                        <button type="button" id="openPrivacy" class="ml-2 text-custom-secondary hover:underline">Data
                            Privacy Policy</button>
                    </div>
                    <p class="text-xs text-gray-600">By clicking on the register button below, I hereby agree to both
                        the Terms of Use and Data Privacy Policy</p>
                </div>
    ...
    <div id="otpModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center p-4 z-50">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            ...
            <form id="otpForm" class="space-y-4">
                ...
                <div class="flex justify-between items-center">
                    <button type="button" id="cancelOtp"
                        class="px-4 py-2 rounded-lg bg-red-500 text-white">Cancel</button>
                    <div class="space-x-2">
                        <button type="button" id="resendOtp" class="px-4 py-2 rounded-lg bg-gray-200 text-gray-800"
                            disabled>Resend OTP</button>
                        <button type="submit" id="submitOtp"
                            class="px-4 py-2 rounded-lg bg-custom-secondary text-white">Verify</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div id="forgotPasswordModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center p-4 z-50">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            ...
            <p class="text-sm text-gray-600 mb-4 text-center">Enter your email. We will send a 6-digit OTP to reset your
                password.</p>
            <form id="forgotPasswordForm" class="space-y-4">
                <div>
                    <label class="block text-sm mb-1">Email Address</label>
                    <input type="email" id="fpEmail" class="w-full px-3 py-2 border border-gray-300 rounded-lg"
                        placeholder="you@email.com" required>
                </div>
                <div class="flex justify-end">
                    <button type="button" id="fpSendOtp"
                        class="px-4 py-2 rounded-lg bg-custom-secondary text-white font-semibold">Send OTP</button>
                </div>
                ...
                <div id="fpStep2" class="hidden space-y-4 pt-2 border-t">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="fpNewPassword" minlength="10"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg pr-10" required>
                            <button type="button"
                                class="absolute inset-y-0 right-0 px-3 text-gray-500 hover:text-gray-700 toggle-password"
                                data-target="fpNewPassword">
                                <i class="far fa-eye"></i>
                            </button>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" id="fpConfirmPassword" minlength="10"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg pr-10" required>
                            <button type="button"
                                class="absolute inset-y-0 right-0 px-3 text-gray-500 hover:text-gray-700 toggle-password"
                                data-target="fpConfirmPassword">
                                <i class="far fa-eye"></i>
                            </button>
                        </div>
                    ...
                    <div class="flex justify-between items-center">
                        <button type="button" id="fpCancel"
                            class="px-4 py-2 rounded-lg bg-red-500 text-white">Cancel</button>
                        <button type="submit" id="fpSubmit"
                            class="px-4 py-2 rounded-lg bg-custom-secondary text-white">Reset Password</button>
                    </div>
                </div>
            </form>
    ...
    <div id="operatorLoginModal"
        class="fixed inset-0 bg-black/40 hidden items-start justify-center pt-20 px-4 overflow-y-auto z-50">
        <div class="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full glass-card form-compact">
            <div
                ...
                <div class="mt-1 text-xs text-gray-500">
                    ...
                    <button type="button" id="openOperatorRegisterFromLogin"
                        class="text-custom-secondary font-semibold hover:underline">Register as operator</button>
                </div>
            </div>
            <form id="operatorLoginForm" method="post" class="space-y-4 pt-4" autocomplete="on">
                ...
                <div>
                    <label class="block text-sm mb-1">Email Address<span class="required-asterisk">*</span></label>
                    <input type="email" id="opLoginEmail" name="email" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                </div>
                <div>
                    <label class="block text-sm mb-1">Password<span class="required-asterisk">*</span></label>
                    <div class="relative">
                        <input type="password" id="opLoginPassword" name="password" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg pr-10">
                        <button type="button"
                            class="absolute inset-y-0 right-0 px-3 text-gray-500 hover:text-gray-700 toggle-password"
                            aria-label="Toggle password visibility" data-target="opLoginPassword">
                            <i class="far fa-eye"></i>
                        </button>
                    </div>
                </div>
                <div class="flex items-center justify-between text-xs text-gray-600 pt-1">
                    ...
                    <button type="button" id="openForgotPassword" class="text-custom-secondary hover:underline">Forgot
                        password?</button>
                </div>
                <div class="flex justify-end space-x-3 pt-3">
                    <button type="button" id="btnOperatorLoginCancel"
                        class="bg-red-500 text-white px-4 py-2 rounded-lg">Cancel</button>
                    <button type="submit" id="btnOperatorLoginSubmit"
                        class="bg-custom-secondary text-white px-4 py-2 rounded-lg">Login</button>
                </div>
            </form>
        </div>
    </div>

    <div id="operatorRegisterModal"
        class="fixed inset-0 bg-black/40 hidden items-start justify-center pt-20 px-4 overflow-y-auto z-50">
        <div class="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full glass-card form-compact">
            <div
                class="sticky top-0 bg-white/95 backdrop-blur border-b border-gray-200 z-10 -mx-6 px-6 py-3 text-center">
            ...
            <form id="operatorRegisterForm" class="space-y-4 pt-4">
                ...
                <div>
                    ...
                    <input type="text" name="full_name" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg" placeholder="Juan Dela Cruz">
                </div>
                <div>
                    <label class="block text-sm mb-1">Email Address<span class="required-asterisk">*</span></label>
                ...
                <div>
                    <label class="block text-sm mb-1">Password<span class="required-asterisk">*</span></label>
                    <div class="relative">
                        <input type="password" id="opRegPassword" name="password" minlength="10" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg pr-10"
                            aria-describedby="opPwdChecklist">
                        <button type="button"
                            class="absolute inset-y-0 right-0 px-3 text-gray-500 hover:text-gray-700 toggle-password"
                            aria-label="Toggle password visibility" data-target="opRegPassword">
                            <i class="far fa-eye"></i>
                        </button>
                    </div>
                    <ul id="opPwdChecklist" class="text-xs text-gray-600 mt-2 space-y-1">
                        <li class="req-item" data-check="length"><span class="req-dot"></span> At least 10 characters
                        </li>
                        ...
                        <li class="req-item" data-check="number"><span class="req-dot"></span> Has a number</li>
                        <li class="req-item" data-check="special"><span class="req-dot"></span> Has a special character
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="opRegConfirmPassword" name="confirm_password" minlength="10" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg pr-10">
                        <button type="button"
                            class="absolute inset-y-0 right-0 px-3 text-gray-500 hover:text-gray-700 toggle-password"
                            aria-label="Toggle password visibility" data-target="opRegConfirmPassword">
                            <i class="far fa-eye"></i>
                        </button>
                    </div>
                </div>
                ...
                <?php endif; ?>
                <div class="flex justify-end space-x-3 pt-2">
                    <button type="button" id="btnOperatorRegisterCancel"
                        class="bg-red-500 text-white px-4 py-2 rounded-lg">Cancel</button>
                    <button type="submit" id="btnOperatorRegisterSubmit"
                        class="bg-custom-secondary text-white px-4 py-2 rounded-lg">Register</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div class="px-6 py-4 space-y-4 text-sm leading-6">
                ...
                <table class="w-full text-left text-xs">
                    <thead>
                        <tr>
                            <th class="py-1 pr-4">Section</th>
                            <th class="py-1">Topic</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="py-1 pr-4">Section A</td>
                            <td class="py-1">General Account Setup and Use</td>
                        </tr>
                        <tr>
                            <td class="py-1 pr-4">Section B</td>
                            <td class="py-1">Technology, Intellectual Property, and Licensing</td>
                        </tr>
                        <tr>
                            <td class="py-1 pr-4">Section C</td>
                            <td class="py-1">Payment Terms, Fees, and Billing</td>
                        </tr>
                        <tr>
                            <td class="py-1 pr-4">Section D</td>
                            <td class="py-1">Data Usage, Privacy, and Security</td>
                        </tr>
                        <tr>
                            <td class="py-1 pr-4">Section E</td>
                            <td class="py-1">Additional Legal Terms and Disclaimers</td>
                        </tr>
                    </tbody>
                </table>
                <h4 class="font-semibold">SECTION A: GENERAL TERMS</h4>
                <p><strong>1. Your Account and Registration</strong></p>
                <p>a. Account Creation: To use our Services, you must create an Account. Your representative
                    (Representative) must provide us with required details, including your entity's name, address,
                    contact person, email, phone number, relevant ID/tax number, and the nature of your
                ...
                <p>d. Representative Authority: You confirm that your Representative has the full authority to provide
                    ...
                    authority.</p>
                <p>e. Validation: We may require additional documentation at any time (e.g., business licenses, IDs) to
                    verify your entity's ownership, control, and the information you provided.</p>
                ...
                <p>a. Lawful Use: You must use the Services lawfully and comply with all applicable Philippine laws,
                    rules, and regulations ("Laws") regarding your use of the Services and the transactions you
                    facilitate ("Transactions").</p>
                <p>b. Prohibited Activities: You may not use the Services to facilitate illegal transactions, or for
                    personal/household use. Specifically, you must not, nor allow others to:</p>
                <ul class="list-disc pl-5">
                    ...
                    <li>Interfere with the normal operation of the Services or impose an unreasonably large load on the
                        system.</li>
                </ul>
                <p><strong>4. Electronic Notices and Consent</strong></p>
                <p>a. Electronic Consent: By registering, you provide your electronic signature and consent to receive
                    all notices and disclosures from us electronically (via our website, email, or text message), which
                    has the same legal effect as a physical signature.</p>
                <p>b. Delivery: We are not liable for non-receipt of notices due to issues beyond our control (e.g.,
                    network outages, incorrect contact details, firewall restrictions). Notices posted or emailed are
                    considered received within 24 hours.</p>
                <p>c. Text Messages: You authorize us to use text messages to verify your account control (like two-step
                    verification) and provide critical updates. Standard carrier charges may apply.</p>
                <p>d. Withdrawing Consent: You can withdraw your consent to electronic notices only by terminating your
                    Account.</p>
                ...
                <ul class="list-disc pl-5">
                    ...
                    <li>We are not liable to you for any damages related to the termination, suspension, or data
                        deletion.</li>
                    <li>You remain liable for any outstanding fees, fines, or financial obligations incurred before
                        termination.</li>
                </ul>
                <h4 class="font-semibold">SECTION B: TECHNOLOGY</h4>
                <p><strong>1. System Access and Updates</strong></p>
                <p>We provide access to the web system and/or mobile application ("Application"). You must only use the
                    Application as described in the Documentation. We will update the Application and Documentation
                    periodically, which may add or remove features, and we will notify you of material changes.</p>
                ...
                <p>a. Billing: Your monthly bill for the upcoming month is generated by the system on the 21st day of
                    the current month and is due after 5 days. Billing is based on the number of registered users
                    ("End-User") as of the 20th day.</p>
                <p>b. Payment Method: All payments must be settled via our third-party Payment System Provider, PayPal.
                    You agree to abide by all of PayPal's terms, and we are not responsible for any issues with their
                    service.</p>
                <p><strong>3. Taxes</strong></p>
                <p>Fees exclude applicable taxes. You are solely responsible for remitting all taxes for your business
                    to the appropriate Philippine tax and revenue authorities.</p>
                <p><strong>4. Payment Processing</strong></p>
                <p>We are not a bank and do not offer services regulated by the Bangko Sentral ng Pilipinas. We reserve
                ...
                <p>We use Data to provide Services, mitigate fraud, and improve our systems. We do not provide Personal
                    Data to unaffiliated parties for marketing purposes.</p>
                <p><strong>2. Data Protection and Privacy</strong></p>
                <p>a. Confidentiality: You will protect all Data received via the Services and only use it in connection
                    with this Agreement. Neither party may use Personal Data for marketing without express consent. We
                    may disclose Data if required by legal instruments (e.g., subpoena).</p>
                <p>b. Privacy Compliance: You affirm that you comply with all Laws governing the privacy and protection
                    of the Data you provide to or access through the Services. You are responsible for obtaining all
                    necessary consents from End-Users to allow us to collect, use, and disclose their Data.</p>
                <p>c. Data Processing Roles: You shall be the data controller, and we shall be the data intermediary. We
                    will process the Personal Data only according to this Agreement and will implement appropriate
                ...
                <p>We are responsible for protecting your Data using commercially reasonable administrative, technical,
                    and physical security measures. However, no system is impenetrable. You agree that you are
                    responsible for implementing your own firewall, anti-virus, anti-phishing, and other security
                    measures ("Security Controls"). We may suspend your Account to maintain the integrity of the
                    Services, and you waive the right to claim losses that result from such actions.</p>
                <h4 class="font-semibold">SECTION E: ADDITIONAL LEGAL TERMS</h4>
                <p><strong>1. Right to Amend</strong></p>
                <p>We can change or add to these terms at any time by posting the changes on our website. Your continued
                    use of the Services constitutes your acceptance of the modified Agreement.</p>
                <p><strong>2. Assignment</strong></p>
                <p>You cannot assign this Agreement or your Account rights to anyone else without our prior written
                    consent. We can assign this Agreement without your consent.</p>
                <p><strong>3. Force Majeure</strong></p>
                <p>Neither party will be liable for delays or non-performance caused by events beyond reasonable
                    control, such as utility failures, acts of nature, or war. This does not excuse your obligation to
                    pay fees.</p>
                ...
                <p>We shall not be responsible or liable to you for any indirect, punitive, incidental, special,
                    consequential, or exemplary damages resulting from your use or inability to use the Services, lost
                    profits, personal injury, or property damage. We are not liable for damages arising from:</p>
                <ul class="list-disc pl-5">
            ...
            <div class="border-t px-6 py-3 flex justify-end">
                <button type="button" id="closeTermsBottom"
                    class="px-4 py-2 rounded-lg bg-custom-secondary text-white">Close</button>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-3xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div class="px-6 py-4 space-y-4 text-sm leading-6">
                ...
                <table class="w-full text-left text-xs">
                    <thead>
                        <tr>
                            <th class="py-1 pr-4">Term</th>
                            <th class="py-1">Definition</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="py-1 pr-4">Personal Data</td>
                            <td class="py-1">Any information that can identify a specific person, whether directly or
                                indirectly, shared or accessible through the Services.</td>
                        </tr>
                        <tr>
                            <td class="py-1 pr-4">User Data</td>
                            <td class="py-1">Information that describes your business operations, services, or internal
                                activities.</td>
                        </tr>
                        <tr>
                ...
                <p>We will not sell or share Personal Data with unaffiliated parties for their marketing purposes. By
                    using our system, you consent to our use of your Data in this manner.</p>
                ...
                <p><em>Your Legal Duty:</em> You affirm that you are, and will remain, compliant with all applicable
                    Philippine laws (including the Data Privacy Act of 2012) governing the collection, protection, and
                ...
                <ul class="list-disc pl-5">
                    ...
                    <li>Not retaining Personal Data longer than necessary to fulfill the purposes set out in our
                        agreement.</li>
                </ul>
                ...
                <p>If we become aware of an unauthorized acquisition, disclosure, change, or loss of Personal Data on
                    our systems (a "Breach"), we will notify you and provide sufficient information to help you mitigate
                    any negative impact, consistent with our legal obligations.</p>
                <h4 class="font-semibold">3. Account Deactivation and Data Deletion</h4>
                <p><strong>Initiating Deactivation</strong></p>
                <p>If you wish to remove your personal information from our systems, you must go to your Edit Profile
                    page and click the 'Deactivate Account' button. This action initiates the data deletion and account
                ...
                <p>We are responsible for implementing commercially reasonable administrative, technical, and physical
                    procedures to protect Data from unauthorized access, loss, or modification. We comply with all
                    applicable Laws in handling Data.</p>
                <p><strong>Your Security Controls</strong></p>
                <p>You acknowledge that no security system is perfect. You agree to implement your own necessary
                    security measures ("Security Controls"), which must include:</p>
                <ul class="list-disc pl-5">
                ...
                <p>We reserve the right to suspend your Account or the Services if necessary to maintain system
                    integrity and security, or to prevent harm. You waive any right to claim losses that result from a
                    Breach or any action we take to prevent harm.</p>
            </div>
            <div class="border-t px-6 py-3 flex justify-end">
                <button type="button" id="closePrivacyBottom"
                    class="px-4 py-2 rounded-lg bg-custom-secondary text-white">Close</button>
            </div>
        </div>
    </div>
