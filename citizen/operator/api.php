...
if ($action === 'get_ai_insights') {
  $insights = [
    ['title' => 'Fleet Health Check', 'desc' => 'Keep inspection status updated to avoid terminal restrictions.', 'type' => 'medium'],
    ['title' => 'Dispatch Reminder', 'desc' => 'Monitor peak demand windows and ensure enough active units are available.', 'type' => 'high'],
  ];
  op_send(true, ['data' => $insights]);
}
