...
<div class="bg-white/80 backdrop-blur-xl border-b border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700/50">
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center space-x-1">
      <button class="relative rounded-xl p-2.5 text-slate-600 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-gradient-to-br hover:from-blue-50 hover:to-blue-100 dark:hover:from-slate-700 dark:hover:to-slate-600 transition-all duration-200 hover:scale-105">
        <i data-lucide="bell" class="w-6 h-6"></i>
        <span class="absolute top-1 right-1 w-4 h-4 text-white text-xs bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center shadow-lg animate-pulse">1</span>
      </button>
