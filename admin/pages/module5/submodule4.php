    ...
    async function loadPayments() {
        ...
        const demoRows = [
          {
            ...
            slot_no: '1',
            or_no: 'OR-2026-000001',
            amount: 20,
            exported_to_treasury: 0,
            exported_at: null,
            slot_id: 0,
            payment_id: 0,
          },
          {
            paid_at: new Date(now.getTime() - 3600 * 1000).toISOString(),
            plate_number: 'UVX-3105',
            slot_no: '2',
            or_no: 'OR-2026-000002',
            amount: 20,
            exported_to_treasury: 1,
            exported_at: new Date(now.getTime() - 3400 * 1000).toISOString(),
            slot_id: 0,
            payment_id: 0,
          },
        ];
      ...
      body.innerHTML = rows.map(r => {
        ...
        const viewBtn = slotId > 0
          ? `<button type="button" data-view-slot="${slotId}" class="btnViewSlot px-3 py-2 rounded-md bg-slate-100 dark:bg-slate-700/50 text-slate-700 dark:text-slate-200 hover:bg-blue-50 dark:hover:bg-blue-900/20">
               <i data-lucide="eye" class="w-4 h-4 mr-1"></i><span>View</span>
             </button>`
          : '';
