        ...
        <div class="p-6">
          <form id="formAddSlot" class="flex flex-col sm:flex-row gap-3 items-end" novalidate>
            ...
            <div class="flex-1">
              ...
              <input name="slot_no" required minlength="2" maxlength="10" pattern="^[A-Za-z0-9\\-]{2,10}$" autocapitalize="characters" class="w-full px-4 py-2.5 rounded-md bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-600 text-sm font-semibold uppercase" placeholder="e.g., P-01">
            </div>
