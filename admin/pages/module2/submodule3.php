        ...
        if (!data || !data.ok) {
          ...
          const msg = (function () {
            ...
            if (code === 'orcr_required_for_approval') {
              ...
              return `Approval needs at least ${need} verified OR/CR. Found ${have}.${plateText}`;
            }
            if (code === 'vehicles_not_ready') {
              ...
              return `Approval needs at least ${need} vehicle ready (linked, inspected, registered, insured). Found ${have}.` + (parts.length ? (' ' + parts.join(' • ')) : '');
            }
