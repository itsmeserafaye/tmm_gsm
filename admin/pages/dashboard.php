  ...
  <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
    <div class="xl:col-span-2 space-y-6">
      ...
      <div class="p-6 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <div id="forecastChartLegend" class="mt-4 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 border-t border-slate-100 dark:border-slate-700 pt-4"></div>
      </div>
    ...
    <div class="space-y-6">
      <div
        class="p-5 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <div class="p-5 rounded-lg bg-gradient-to-br from-amber-50 to-orange-50 dark:from-slate-800 dark:to-slate-800 border border-amber-100 dark:border-slate-700 shadow-sm">
        <div class="flex items-center justify-between mb-5">
           <div class="flex items-center gap-3">
              <div class="p-2 rounded-lg bg-amber-100 dark:bg-slate-700 text-amber-600 dark:text-amber-400 shadow-sm">
                 <i data-lucide="sparkles" class="w-5 h-5"></i>
              </div>
              <div>
                 <h2 class="text-base font-bold text-slate-900 dark:text-white">AI Recommendations</h2>
                 <div class="text-xs text-slate-500">Smart actions based on forecast</div>
              </div>
           </div>
        </div>
        ...
        <div class="space-y-4">
          ...
          <div class="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm transition-all hover:shadow-md hover:border-rose-200 dark:hover:border-rose-900/50">
            <div class="absolute top-0 left-0 w-1 h-full bg-rose-500"></div>
            <div class="p-4">
              <div class="flex items-center gap-2 mb-3">
                  <span class="flex h-6 w-6 items-center justify-center rounded-full bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400">
                      <i data-lucide="trending-up" class="w-3.5 h-3.5"></i>
                  </span>
                  <span class="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">High Demand Strategy</span>
              </div>
              <ul id="insightsOver" class="space-y-2.5">
              </ul>
            </div>
          </div>

          <!-- Under Demand Playbook -->
          <div class="group relative overflow-hidden rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm transition-all hover:shadow-md hover:border-emerald-200 dark:hover:border-emerald-900/50">
            <div class="absolute top-0 left-0 w-1 h-full bg-emerald-500"></div>
            <div class="p-4">
              <div class="flex items-center gap-2 mb-3">
                  <span class="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400">
                      <i data-lucide="trending-down" class="w-3.5 h-3.5"></i>
                  </span>
                  <span class="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">Low Demand Strategy</span>
              </div>
              <ul id="insightsUnder" class="space-y-2.5">
              </ul>
            </div>
          </div>
      </div>
