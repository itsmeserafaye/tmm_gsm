      ...
      <form id="formRegister" class="space-y-5" novalidate>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input name="orcr_no" required minlength="3" maxlength="40" pattern="^[A-Za-z0-9\\-\\/]{3,40}$" class="w-full px-4 py-2.5 rounded-md bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-600 text-sm font-semibold" placeholder="e.g., ORCR-2026-0001">
          </div>
          <div>
