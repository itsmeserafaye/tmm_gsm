    ...
    <?php if (has_permission('reports.export')): ?>
      <?php tmm_render_export_toolbar([
        ...
        [
          ...
          'icon' => 'printer',
          'attrs' => [
            'data-print-url' => $rootUrl . '/admin/api/module1/print_operator_validation.php?' . http_build_query(['q' => $q, 'operator_type' => $type, 'status' => $status]),
            'data-report-name' => 'Operator Document Validation Report'
          ]
        ]
      ]); ?>
    <?php endif; ?>
