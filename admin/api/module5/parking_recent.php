...
if ($kind === 'payments') {
  $sql = "SELECT t.id, t.vehicle_plate, t.parking_area_id, t.amount, t.status, t.created_at, t.paid_at, t.payment_method, t.payment_channel, t.receipt_ref, t.reference_no, p.name AS area_name
