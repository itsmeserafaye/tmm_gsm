...
$rep_title = trim((string)($_GET['rep_title'] ?? 'Vehicles Report'));
...
$filterParts[] = 'Record Status: ' . (($recordStatus !== '' && $recordStatus !== 'Record status') ? $recordStatus : 'All');
$filterParts[] = 'Docu: ' . (($docuStatus !== '' && $docuStatus !== 'Docu status') ? $docuStatus : 'All');
          ...
          <th colspan="6" style="background:#fff;border:0;padding:0">
            <div class="rhead">
              ...
              <div class="rtitle">
                ...
                <div class="sub"><?php echo htmlspecialchars($rep_title !== '' ? $rep_title : 'Vehicles Report'); ?></div>
                <?php if ($office_addr !== ''): ?>
