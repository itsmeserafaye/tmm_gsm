...
$rep_title = trim((string)($_GET['rep_title'] ?? 'Violations Report'));
...
$filterParts = [];
$filterParts[] = 'Status: ' . ($wf !== '' ? $wf : 'All');
$filterParts[] = 'From: ' . ($from !== '' ? $from : '—');
$filterParts[] = 'To: ' . ($to !== '' ? $to : '—');
          ...
          <th colspan="6" style="background:#fff;border:0;padding:0">
            <div class="rhead">
              ...
              <div class="rtitle">
                ...
                <div class="sub"><?php echo htmlspecialchars($rep_title !== '' ? $rep_title : 'Violations Report'); ?></div>
                <?php if ($office_addr !== ''): ?>
